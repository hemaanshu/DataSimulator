...
{
    public class ApplicationFault : IInit
    {
        ...
        public void Initialize(Random rnd, Guid machineId, Guid sessionKey)
        {
            ...
            var startTime = endTime.AddDays(-1 * Config.Instance.SimulationTimeRange);
            var randomOffset = new TimeSpan((long)(rnd.NextDouble() * TimeSpan.FromDays(Config.Instance.SimulationTimeRange).Ticks));
            ...
            this.FaultReportedDate = startTime + randomOffset;
